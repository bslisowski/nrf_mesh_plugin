...
_$_ConfigNetworkTransmitStatus _$$_ConfigNetworkTransmitStatusFromJson(
        Map<String, dynamic> json) =>
    _$_ConfigNetworkTransmitStatus(
      json['source'] as int,
...
Map<String, dynamic> _$$_ConfigNetworkTransmitStatusToJson(
