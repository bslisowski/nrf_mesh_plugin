...
_$_UnprovisionedMeshNodeData _$$_UnprovisionedMeshNodeDataFromJson(
...
Map<String, dynamic> _$$_UnprovisionedMeshNodeDataToJson(
...
_$_ProvisionedMeshNodeData _$$_ProvisionedMeshNodeDataFromJson(
        Map<String, dynamic> json) =>
    _$_ProvisionedMeshNodeData(
      json['uuid'] as String,
    );

Map<String, dynamic> _$$_ProvisionedMeshNodeDataToJson(
        _$_ProvisionedMeshNodeData instance) =>
    <String, dynamic>{
      'uuid': instance.uuid,
    };

_$_MeshProvisioningStatusData _$$_MeshProvisioningStatusDataFromJson(
        Map json) =>
...
Map<String, dynamic> _$$_MeshProvisioningStatusDataToJson(
...
_$_MeshProvisioningCompletedData _$$_MeshProvisioningCompletedDataFromJson(
        Map json) =>
...
Map<String, dynamic> _$$_MeshProvisioningCompletedDataToJson(
